...
public interface Ship<T> {
     ...
     * @param myShip is true for my ship; false for enemy's ship
     * @throws IllegalArgumentException if where is not part of the Ship
     * @return The view-specific information at that coordinate.
     * e.g. for selfShip, return 's' not hit, '*' onHit;
     * for enemyShip, return blank not hit, 's' onHit, 'X' missed.
     */
    public T getDisplayInfoAt(Coordinate where, boolean myShip);

    /**
     * Get all  Coordinates that this Ship occupies.
     * @return An Iterable with the coordinates that this Ship occupies
     */
    public Iterable<Coordinate> getCoordinates();

    /**
     * Get the upperLeft coordinates of this ship basing on the input coordinate
     * @return is the upperLeft coordinates of this ship
     */
    public Coordinate getUpperLeft();

    /**
     * Get all hit coordinates on this ship
     * @return is the hashset of all hit coords on this ship
     */
    public HashSet<Coordinate> getAllHitCoords();

    /**
     * Get the relative graphical center of the ship
     * @return is the coordinate
     */
    public Coordinate getCenter();

    /**
     * Get array format relative coordinates
     * @return is the array of coordinates in the ship
     */
    public Coordinate[] getRelative();

    /**
     * Check whether this ship is hit
     * @return true for hit.
     */
