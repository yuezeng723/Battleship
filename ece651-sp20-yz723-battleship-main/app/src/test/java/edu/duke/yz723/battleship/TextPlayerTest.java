...
class TextPlayerTest {
    ...
    private TextPlayer createTextPlayer_V2(int w, int h, String inputData, OutputStream bytes, String name) {
        BufferedReader input = new BufferedReader(new StringReader(inputData));
        PrintStream output = new PrintStream(bytes, true);
        Board<Character> board = new BattleShipBoard<Character>(w, h, 'X');
    ...
    private TextPlayer createTextPlayer_V2_new(int w, int h, String inputData, OutputStream bytes, String name, int sonarRemain, int moveRemain) {
        BufferedReader input = new BufferedReader(new StringReader(inputData));
        PrintStream output = new PrintStream(bytes, true);
        Board<Character> board = new BattleShipBoard<Character>(w, h, 'X');
        V2ShipFactory shipFactory = new V2ShipFactory();
        return new TextPlayer(name, board, input, output, shipFactory, sonarRemain, moveRemain);
    }


    @Test
    void test_read_placement_eof()throws IOException{
        TextPlayer testPlayer = createTextPlayer(10,20, "",new ByteArrayOutputStream(),"A");
    ...
    void test_read_placement() throws IOException {
        ...
        TextPlayer playerA = createTextPlayer(10, 20, "B2V\nC8H\na4v\n", bytes, "A");
        String prompt = "Please enter a location for a ship:";
    ...
    void test_readPlacement_wrong_Placement_till_to_right() throws IOException{
        ...
        TextPlayer playerA = createTextPlayer(3, 5, "B1Z\nB1U", bytes, "A");
    ...
    void test_doOnePlacement_success() throws IOException{
        ByteArrayOutputStream bytes = new ByteArrayOutputStream();
        PrintStream ps =System.out;
        TextPlayer playerA = createTextPlayer(3, 5, "B1V\n", bytes, "A");
        String prompt = "Player "+ playerA.name +" where do you want to place a Destroyer?";
    ...
    void test_doOnePlacement_failed_ruleChecker()throws IOException{
        ByteArrayOutputStream bytes = new ByteArrayOutputStream();
        PrintStream ps =System.out;
        TextPlayer playerA = createTextPlayer(3, 5, "B2H\n", bytes, "A");
        String prompt = "Player "+ playerA.name +" where do you want to place a Destroyer?";
        String expectedHeader ="  0|1|2  \n";
        String expectedRow =
                "A  | |  A\n"+
        ...
        playerA.doOnePlacement("Destroyer", playerA.shipCreationFns.get("Destroyer"));
        System.setOut(new PrintStream(bytes));
        assertEquals(prompt + "\n" + expectedMessage + expected, bytes.toString());
    }

    @Test
    void test_read_one_coordinate_validInput() throws IOException{
        ByteArrayOutputStream bytes = new ByteArrayOutputStream();
        TextPlayer playerA = createTextPlayer(10, 20, "B2\nC8\na4\n", bytes, "A");
    ...
    void test_read_one_coordinate_invalid_Input() throws IOException{
        ByteArrayOutputStream bytes = new ByteArrayOutputStream();
        TextPlayer playerA = createTextPlayer(10, 20, "@8\na0\n", bytes, "A");
        String prompt =
    ...
    void test_play_one_turn_hit() throws IOException{
        ByteArrayOutputStream bytes = new ByteArrayOutputStream();
        PrintStream ps =System.out;
        TextPlayer playerA = createTextPlayer(3, 5, "a0\n", bytes, "A");
        ...
        String expectedHit =
                ...
                "You hit a Submarine!\n"+
                "--------------------------------------------------------------------------------\n";
        playerA.playOneTurn("Yue", enemyBoard, enemyView);
        System.setOut(new PrintStream(bytes));
    ...
    void test_play_one_turn_miss() throws IOException{
        ...
        TextPlayer playerA = createTextPlayer(3, 5, "b0\n", bytes, "A");
        BattleShipBoard<Character> enemyBoard = new BattleShipBoard<Character>(3,5,'X');
        BoardTextView enemyView = new BoardTextView(enemyBoard);
        V1ShipFactory sf = new V1ShipFactory();
        playerA.theBoard.tryAddShip(sf.makeSubmarine(new Placement("a0h")));
        ...
        String expectedHit =
                ...
                "--------------------------------------------------------------------------------\n"+
                        "You missed!\n"+
                        "--------------------------------------------------------------------------------\n";
        assertTrue(playerA.playOneTurn("Yue", enemyBoard, enemyView));
        System.setOut(new PrintStream(bytes));
        assertEquals(prompt + expected + expectedHit, bytes.toString());
        System.setOut(ps);
    }
    ...
    void test_playOneTurn_lose() throws IOException{
        ...
        TextPlayer playerA = createTextPlayer(3, 5, "b1\n", bytes, "A");
        TextPlayer playerB = createTextPlayer(3, 5, "a1\n", bytes, "B");
        V1ShipFactory sf = new V1ShipFactory();
        playerA.theBoard.tryAddShip(sf.makeSubmarine(new Placement("a0h")));
        ...
        assertTrue(playerA.playOneTurn("B", playerB.theBoard, playerB.view));
        assertFalse(playerB.playOneTurn("A", playerA.theBoard, playerA.view));
        //now, player A is lose, but enter into the playOneTurn
        //player A will do nothing, but get a false return
        assertFalse(playerA.playOneTurn("B", playerB.theBoard, playerB.view));
        System.setOut(new PrintStream(bytes));
    ...
    void test_doPlacementPhase() throws IOException {
        ...
        TextPlayer playerA = createTextPlayer_V2(10, 20, "A0V\nA1u\nA0v\nB0v\nA1V\nA2V\nA3V\nA4V\nA5u\nC5U\nE5U\nA8U\nf8v\nf8r\nt0v\nG5D\n", bytes, "A");
    ...
    void test_readChoice_F() throws IOException{
        ByteArrayOutputStream bytes = new ByteArrayOutputStream();
        TextPlayer playerA = createTextPlayer(3,5,"F\n",bytes,"A");
    ...
    void test_readChoice_M_2_remains() throws IOException{
        ByteArrayOutputStream bytes = new ByteArrayOutputStream();
        TextPlayer playerA = createTextPlayer(3,5,"M\n",bytes,"A");
        Character c = playerA.readChoice();
        assertEquals('M', c);
    ...
    void test_readChoice_S_2_remains() throws IOException{
        ByteArrayOutputStream bytes = new ByteArrayOutputStream();
        TextPlayer playerA = createTextPlayer(3,5,"s\n",bytes,"A");
        Character c = playerA.readChoice();
        assertEquals('S', c);
    ...
    void test_readChoice_S_failed() throws IOException{
        ByteArrayOutputStream bytes = new ByteArrayOutputStream();
        PrintStream ps =System.out;
        TextPlayer playerA = createTextPlayer_V2_new(3,5,"s\nf\n",bytes,"A", 0, 3);
        playerA.readChoice();
    ...
    void test_readChoice_M_failed() throws IOException{
        ByteArrayOutputStream bytes = new ByteArrayOutputStream();
        PrintStream ps =System.out;
        TextPlayer playerA = createTextPlayer_V2_new(3,5,"m\nf\n",bytes,"A", 2, 0);
        playerA.readChoice();
        //assertEquals(0, playerA.sonarRemain);
        String expected =
                "Please enter into your choice:\n"+
    ...
    void test_play_one_round_with_fire_and_move() throws IOException{
        ...
        System.setOut(new PrintStream(bytes));
        //run doPlacementPhase, get System.out
        TextPlayer playerA = createTextPlayer_V2(10, 20,"M\nE2\nc5R" , bytes, "A");
    ...
    void test_PlaySonar() throws IOException{
        ByteArrayOutputStream bytes = new ByteArrayOutputStream();
        TextPlayer playerA = createTextPlayer_V2_new(10,20,"a0\n",bytes, "A",3,3);
        BattleShipBoard<Character> enemyBorad = new BattleShipBoard<Character>(10,20,'X');
        BoardTextView enemyView = new BoardTextView(enemyBorad);
        V2ShipFactory sf = new V2ShipFactory();
